...
product = 11 * 19 * 5 * 2 * 13 * 7 * 3 * 17

for _ in range(10000):
    for monkey in monkeys:
        for i, item in enumerate(monkey["items"]):

            # Only the result modulo product of all the divisors in the checks matters.
            # The actual numbers aren't used anywhere.
            result = monkey["operation"](item) % product
